...
Modes: --encryption (repokey|keyfile)-[blake2-](chacha20-poly1305|aes-ocb)
...
- Blake2b - very fast hash algorithm, with a high security rating (recommended)
- HMAC-SHA256 - fast if hardware accelerated by the processor, with the SHA256 instruction set
