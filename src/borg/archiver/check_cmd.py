...
class CheckMixIn:
    ...
    def do_check(self, args, repository):
        ...
        if args.max_duration and not args.repo_only:
            ...
            # Thus, we should not do archive checks based on a unknown-quality on-disk repo index.
